...
public class GetExampleSoftDeletableEntityByIdQueryHandler
    : IRequestHandler<GetExampleSoftDeletableEntityByIdQuery, ApiResponse<ExampleSoftDeletableEntityDto>>
{
    private readonly IRepository<ExampleSoftDeletableEntity> _repository;
    private readonly IMapper _mapper;

    public GetExampleSoftDeletableEntityByIdQueryHandler(
    ...
    public async Task<ApiResponse<ExampleSoftDeletableEntityDto>> Handle(
        GetExampleSoftDeletableEntityByIdQuery request,
        CancellationToken cancellationToken)
    {
        ...
        ExampleSoftDeletableEntityDto dto = _mapper.Map<ExampleSoftDeletableEntityDto>(entity);
        return ApiResponse<ExampleSoftDeletableEntityDto>.Success(dto);
    }
}
